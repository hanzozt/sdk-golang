...
1. Run this script to create everything you need.
       ...
       zt edge create service grpc --role-attributes grpc-service

       echo Create three identities and enroll them
       zt edge create identity device grpc.client -a grpc.clients -o grpc.client.jwt
       zt edge create identity device grpc.server -a grpc.servers -o grpc.server.jwt
       zt edge enroll --jwt grpc.server.jwt
       zt edge enroll --jwt grpc.client.jwt

       echo Create service policies
       zt edge create service-policy grpc.dial Dial --identity-roles '#grpc.clients' --service-roles '#grpc-service'
       zt edge create service-policy grpc.bind Bind --identity-roles '#grpc.servers' --service-roles '#grpc-service'
...
zt edge delete service-policy grpc.dial
zt edge delete service-policy grpc.bind

echo Removing identities
zt edge delete identity grpc.client
zt edge delete identity grpc.server

echo Removing service
zt edge delete service grpc
```
