...
func Test_AddressMatch(t *testing.T) {
	...
	hostname, _ := edge.NewZitiAddress("plain.host.zt")
	domain, _ := edge.NewZitiAddress("*.domain.zt")
	...
	cases := []struct {
		...
		{params: args{Network: "udp", Hostname: "plain.host.zt", Port: 80}, expected: -1},
		{params: args{Network: "tcp", Hostname: "plain.host.zt", Port: 80}, expected: 0, name: "httpByHostname"},

		{params: args{Network: "tcp", Hostname: "foo.domain.zt", Port: 80}, expected: 3 << 16, name: "httpByDomain"},
		{params: args{Network: "tcp", Hostname: "foo.host.notzt", Port: 80}, expected: -1},

		{params: args{Network: "udp", Hostname: "bar.domain.zt", Port: 22}, expected: 3<<16 | 1024, name: "adminByDomain"},
