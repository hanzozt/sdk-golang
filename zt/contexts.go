...
// Package zt provides methods for loading Contexts which interact with an Hanzo ZT Controller via the Edge Client
...
// NewId will return a unique string id suitable for zt.Context Id functionality.
func NewId() string {
	id := idCount.Add(1)
